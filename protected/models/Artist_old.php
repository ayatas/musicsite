...
class Artist extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('userId, genreId, bandName', 'required','on'=>'update'),
			array('bandName', 'required','on'=>'create'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'homePage' => 'Home Page',
			'recommendedheading' => 'Heading',
			'albumUrl'=>' Musichut album URL',
			'albumDescription'=>'Why it’s a great record',
